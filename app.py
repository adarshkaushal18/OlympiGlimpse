...
st.sidebar.image('https://www.canr.msu.edu/contentAsset/image/3a2f8e97-7517-4da3-9d21-a17b375ecf51/fileAsset/filter/Resize,Jpeg/resize_w/750/jpeg_q/80', use_column_width=True)
...
if user_menu == 'Overall Analysis':
    ...
    # Pivot table to create a matrix where rows are Sports and columns are Years
...
if user_menu == 'Athlete wise Analysis':
    ...
    selected_sport = st.selectbox('Select a Sport', sport_list)
    # Filter the data based on the selected sport (Assuming helper.weight_v_height does this)
